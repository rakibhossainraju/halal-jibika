  ...
  return (
    <main className="bg-lime-light">
      <section className="flex flex-col items-center justify-center text-center leading-[1.8] min-h-208 bg-[url('/assets/images/flower.png'),url('/assets/images/rotated-flower.png')] bg-no-repeat bg-position-[-6rem_10rem,97rem_-18rem] bg-size-[48rem_auto] animate-[animateBgiToTop_1.7s_ease]">
        <h3 className="text-up-green-hc text-[6.5rem] font-el-messiri">Job Details</h3>
        <h5 className="text-up-green-hc text-[2.4rem] font-normal italic max-w-240">
          &ldquo; Embark on a Journey with Us. Explore Our Job Opportunities &
          Requirements! &ldquo;
        </h5>
      </section>

      <section className="bg-white shadow-[0_-10px_1.5rem_1rem_rgba(29,98,18,0.03)] rounded-t-[50px] flex justify-center gap-32 py-48 pb-20 min-h-200 [counter-reset:requirement-counter]">
        <div className="max-w-312">
          <div>
            <p className="text-[1.8rem] font-light text-gray-20">
              13 October 2024 by <span className="font-medium text-up-green-hc">Deloitte</span>
            </p>
            <h4 className="text-[3.5rem] font-semibold text-up-green-hc mt-2 mb-8">
              Learning and Development Manager
            </h4>
            <div className="my-12 mb-20">
              <a href="#" className="inline-block px-[3.3rem] py-2 bg-lime-light text-[1.5rem] font-semibold text-up-green-hc rounded-[5px] mr-4 transition-colors duration-500 hover:bg-[#32d90e75]">Facebook</a>
              <a href="#" className="inline-block px-[3.3rem] py-2 bg-lime-light text-[1.5rem] font-semibold text-up-green-hc rounded-[5px] mr-4 transition-colors duration-500 hover:bg-[#32d90e75]">Twitter</a>
              <a href="#" className="inline-block px-[3.3rem] py-2 bg-lime-light text-[1.5rem] font-semibold text-up-green-hc rounded-[5px] mr-4 transition-colors duration-500 hover:bg-[#32d90e75]">Copy</a>
            </div>
          </div>

          <div className="rounded-[20px] outline-solid outline-1 outline-[#266900] p-18 mb-16">
            <h5 className="text-[2.7rem] font-semibold text-up-green-hc flex items-center mb-8 before:[counter-increment:requirement-counter] before:content-[counter(requirement-counter)] before:text-white before:bg-[#46ad02] before:rounded-full before:text-[1.5rem] before:inline-flex before:items-center before:justify-center before:mr-[0.8rem] before:w-[2.8rem] before:aspect-square">
              Overview
            </h5>
            <p className="text-[1.9rem] font-light leading-[1.7] text-gray-10">
          ...
          <div className="rounded-[20px] outline-solid outline-1 outline-[#266900] p-18 mb-16">
            ...
            <p className="text-[1.9rem] font-light leading-[1.7] text-gray-10 mt-8">
          ...
          <div className="rounded-[20px] outline-solid outline-1 outline-[#266900] p-18 mb-16">
            ...
            <ul className="px-8 space-y-[1.7rem]">
              {responsibilities.map((data) => (
                <li key={data} className="list-image-[url('/assets/images/check-mark.svg')] text-[#2a8300]">
                  <p className="text-[1.9rem] font-light leading-[1.7] text-gray-10">{data}</p>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div className="rounded-[20px] outline-solid outline-1 outline-[#266900] p-18 mb-16">
            ...
            <ul className="px-8 space-y-[1.7rem] list-disc">
              {requiredSkills.map((data) => (
                <li key={data} className="text-[#2a8300]">
                  <p className="text-[1.9rem] font-light leading-[1.7] text-gray-10">{data}</p>
                </li>
              ))}
            </ul>
