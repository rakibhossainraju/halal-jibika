...
const JobDetailCardComponent: React.FC = () => {
  return (
    <section className="bg-lime-light rounded-[20px] px-12 w-140 max-h-260">
      <div className="flex flex-col items-center justify-center gap-6 my-16">
        ...
        <ButtonComponent className="text-[1.6rem] font-normal px-10 py-[0.8rem] bg-forest hover:bg-[#1b7a71]">
          Visit Website
        </ButtonComponent>
      </div>
      <hr className="max-w-[70%] border-none border-t border-solid border-gray-400/30 mx-auto my-12" />
      <div className="pb-8">
        ...
        <div className="my-4 flex flex-wrap gap-3">
          <a href="#" className="text-[1.3rem] font-medium outline-solid outline-1 outline-up-green-hc rounded-[20px] px-8 py-[0.2rem] pb-2 transition-all duration-1000 hover:bg-up-lime hover:outline-transparent">design</a>
          <a href="#" className="text-[1.3rem] font-medium outline-solid outline-1 outline-up-green-hc rounded-[20px] px-8 py-[0.2rem] pb-2 transition-all duration-1000 hover:bg-up-lime hover:outline-transparent">seo</a>
          <a href="#" className="text-[1.3rem] font-medium outline-solid outline-1 outline-up-green-hc rounded-[20px] px-8 py-[0.2rem] pb-2 transition-all duration-1000 hover:bg-up-lime hover:outline-transparent">ui/ux</a>
        </div>
        <ButtonComponent className="bg-up-lime-hc text-white font-semibold w-full mt-8">Apply Now</ButtonComponent>
      </div>
    </section>
  );
};
