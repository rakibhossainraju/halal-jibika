...
const JobPortal: React.FC<JobPortalProps> = ({ btnBg = "white", className = '', ...otherProps }) => {
  ...
  return (
    <section className={`flex justify-center items-center gap-92 my-20 mb-28 ${className}`} {...otherProps}>
      <div>
        <h3 className="text-up-black-dark text-[5.4rem] font-el-messiri font-semibold">Most complete job portal.</h3>
        <p className="text-[2.6rem] font-light text-gray-40">Signup and start find your job or talents.</p>
      </div>
